            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    {!localStorage.getItem('token') ? <form form className="d-flex" >
                        ...
                        <Link className="btn btn-outline-success mx-1" to="/registration" role="button">Sign Up</Link></form> :
                        <Link className="btn btn-outline-success mx-1" to="/login" role="button" onClick={handleLogout}>Logout</Link>
                    }
                </div>
            </div >
        </nav >
